...
useEffect(() => {
  testdata && setDurationValue(parseInt(((testdata.scripts[testdata.scripts.length-1].end)/1000)*30+20));
},[testdata]);
  return (
    <>
      { testdata && <Composition
        component={VideoPlayer}
        id='VideoPlayer'
        durationInFrames={durationValue?durationValue:100}
        fps={30}
        width={300}
        height={450}
        defaultProps={{
